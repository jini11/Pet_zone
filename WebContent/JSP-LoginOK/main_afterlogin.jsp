...
<body onload="afterlogin_showImage()">
	...
	<div>
		<table class="main_table">
			<tr>
				<td><a href="../JSP-LoginOK/outdoors.jsp"><img src="../Images/outdoors.png"><p>야외</p></td>
				<td><a href="../JSP-LoginOK/food.jsp"><img src="../Images/food.png"><p>음식점</p></a></td>
				<td><a href="../JSP-LoginOK/accommodation.jsp"><img src="../Images/accommodation.png"><p>숙박</p></td>
				<td><a href="../JSP-LoginOK/all.jsp"><img src="../Images/all.png"><p>전체</p></td>
