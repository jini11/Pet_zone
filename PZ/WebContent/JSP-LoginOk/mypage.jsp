...
<!-- 하얀색 백그라운드 div -->
 <div class="white_background">
   ...
   %>
   <p class="mypage_id"><%= list.get(i).getUserName() %> 님</p>
   <br>
   	...
   	<form method="post" action="../logoutAction.jsp">
   		<a href="../logoutAction.jsp" class="button_logout" onclick="Logout_alert()">LOGOUT </a>
   	</form>
   	<form method = "post" action = "dropoutAction.jsp">
		<a href="dropoutAction.jsp" class="button_dropout" onclick="Dropout_alert()">DROP OUT</a>
   	</form>
